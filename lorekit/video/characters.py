...
Loads character descriptions from character JSON files and provides
...
# Keys: theme -> character_id -> description
# ---------------------------------------------------------------------------
...
def get_all_themed_characters(character_id: str) -> dict[str, str]:
    ...
    for theme_key in _THEMED_CHARACTERS:
        desc = get_character_description(character_id, theme=theme_key)
